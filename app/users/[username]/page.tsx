            ...
            <div className='mt-4 flex flex-col xl:flex-row gap-8'>
                ...
                <div className='w-full xl:w-1/3 space-y-6'>
                    ...
                    <div className='p-4 bg-primary-foreground rounded-lg'>
                        ...
                        <div className='space-y-4 mt-4'>
                            <div className='flex flex-col g2 mb-8'>
                                <p className='text-sm text-muted-foreground mb-1'>Profile Completition</p>
                                <Progress value={66} />
                            </div>
                ...
                <div className='w-full xl:w-2/3 space-y-6'>
                    ...
                    <div className='bg-primary-foreground p-4 rounded-lg space-y-2'>
                        ...
                        <p className='text-sm text-muted-foreground'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse ullam omnis quam, quis iure a dolor ad. Consectetur aut repellendus aliquid harum ullam, quam neque vitae excepturi soluta, amet ipsam.</p>
                    </div>
                    {/* chart container */}
